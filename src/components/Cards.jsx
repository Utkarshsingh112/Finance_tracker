      ...
      <div className="p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          ...
          <motion.div
            ...
            className="border-2 border-dashed border-gray-300 rounded-xl p-6 h-48 flex flex-col items-center justify-center hover:border-primary-400 transition-colors cursor-pointer"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Active Cards</h3>
            <p className="text-3xl font-bold text-blue-600">{cards.length}</p>
            <p className="text-sm text-gray-500 mt-1">Currently linked</p>
          </div>
          
          <div className="bg-white rounded-xl p-6 shadow-sm">
            <h3 className="text-lg font-semibold text-gray-900 mb-2">Monthly Spending</h3>
